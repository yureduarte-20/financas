...
<div x-data="{ 
    ...
    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Expenses Link -->
                <a href="{{ route('expenses.index') }}" wire:navigate @class([
                    'flex items-center px-3 py-2 text-sm font-medium rounded-md border-l-4 transition-colors duration-200',
                    'bg-primary-50 border-primary-500 text-primary-700 dark:bg-primary-950/50 dark:border-primary-400 dark:text-primary-300' => request()->routeIs('expenses.*'),
                    'text-gray-700 hover:bg-gray-50 hover:text-gray-900 border-transparent dark:text-dark-muted dark:hover:bg-dark-surface-hover/50 dark:hover:text-neutral-100' => !request()->routeIs('expenses.*'),
                ])>
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Incomes Link -->
                <a href="{{ route('incomes.index') }}" wire:navigate @class([
                    'flex items-center px-3 py-2 text-sm font-medium rounded-md border-l-4 transition-colors duration-200',
                    'bg-primary-50 border-primary-500 text-primary-700 dark:bg-primary-950/50 dark:border-primary-400 dark:text-primary-300' => request()->routeIs('incomes.*'),
                    'text-gray-700 hover:bg-gray-50 hover:text-gray-900 border-transparent dark:text-dark-muted dark:hover:bg-dark-surface-hover/50 dark:hover:text-neutral-100' => !request()->routeIs('incomes.*'),
                ])>
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('documents.import') }}" wire:navigate @class([
                    'flex items-center px-3 py-2 text-sm font-medium rounded-md border-l-4 transition-colors duration-200',
                    'bg-primary-50 border-primary-500 text-primary-700 dark:bg-primary-950/50 dark:border-primary-400 dark:text-primary-300' => request()->routeIs('documents.import'),
                    'text-gray-700 hover:bg-gray-50 hover:text-gray-900 border-transparent dark:text-dark-muted dark:hover:bg-dark-surface-hover/50 dark:hover:text-neutral-100' => !request()->routeIs('documents.import'),
                ])>
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
