...
<body class="bg-gray-50 dark:bg-[#0a0a0a] text-gray-900 dark:text-gray-100 font-sans antialiased">
    <!-- Header -->
    <header class="fixed top-0 inset-x-0 z-50 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-md border-b border-gray-200 dark:border-neutral-800">
        ...
        <div class="relative overflow-hidden pt-32 pb-20 lg:pt-48 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            <div class="relative flex flex-col lg:flex-row items-center gap-16">
                ...
                <div class="flex-1 text-center lg:text-left">
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent-50 dark:bg-[#1D0002] text-primary text-sm font-semibold mb-6">
                    ...
                    <p class="text-lg sm:text-xl text-gray-600 dark:text-neutral-400 mb-8 max-w-2xl mx-auto lg:mx-0">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                        ...
                        <a href="#features" class="w-full sm:w-auto px-8 py-3 text-base font-medium text-gray-700 dark:text-neutral-200 bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl hover:bg-gray-50 dark:hover:bg-neutral-700 transition-all">
                            Como Funciona
                        </a>
                    </div>
                </div>
                ...
                <div class="flex-1 w-full max-w-lg lg:max-w-none relative">
                    ...
                    <div class="relative bg-white dark:bg-[#161615] rounded-2xl border border-gray-200 dark:border-neutral-800 shadow-2xl p-6 overflow-hidden">
                        <!-- Toolbar -->
                        <div class="flex items-center gap-2 mb-4">
                            <div class="w-3 h-3 rounded-full bg-red-400"></div>
                            <div class="w-3 h-3 rounded-full bg-yellow-400"></div>
                            <div class="w-3 h-3 rounded-full bg-green-400"></div>
                            <div class="ml-4 h-4 w-32 bg-gray-100 dark:bg-neutral-800 rounded"></div>
                        </div>

                        <!-- Content mock -->
                        <div class="space-y-4">
                            <div class="h-32 bg-gray-50 dark:bg-neutral-900 border border-dashed border-gray-300 dark:border-neutral-700 rounded-xl flex items-center justify-center">
                                <div class="text-center text-gray-400 dark:text-neutral-600 text-sm flex flex-col items-center">
                            ...
                            <div class="bg-gray-50 dark:bg-neutral-800/50 rounded-xl p-4 border border-gray-100 dark:border-neutral-800">
                                <div class="flex justify-between items-start mb-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-gray-500 dark:text-neutral-500">21 Abr 2026</div>
                                        </div>
                                    </div>
                                    <div class="font-bold text-primary">- R$ 32,50</div>
                                </div>
                                <div class="flex items-center justify-between mt-3 pt-3 border-t border-gray-200 dark:border-neutral-700">
                                    <span class="text-xs text-gray-500 dark:text-neutral-400 flex items-center gap-1">
        ...
        <div id="features" class="py-24 bg-white dark:bg-[#111110]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <!-- Feature 1 -->
                    <div class="bg-gray-50 dark:bg-neutral-900 rounded-2xl p-6 border border-gray-100 dark:border-neutral-800 hover:shadow-lg transition-shadow">
                        <div class="w-12 h-12 bg-accent-50 dark:bg-[#1D0002] rounded-xl flex items-center justify-center text-primary mb-4">
    ...
    <!-- Footer -->
    <footer class="bg-white dark:bg-[#0a0a0a] border-t border-gray-200 dark:border-neutral-800 py-12">
