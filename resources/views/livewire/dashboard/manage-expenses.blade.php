<div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="bg-white dark:bg-dark-surface border border-surface-200 dark:border-dark-border rounded-lg p-4">
            <h2 class="text-lg font-semibold mb-4 dark:text-dark-text">
                {{ $editing ? 'Editar despesa' : 'Selecione uma despesa para editar' }}
            </h2>
            ...
            @else
                <p class="text-sm text-gray-600 dark:text-dark-muted">
                    Clique em "Editar" na lista abaixo para carregar os dados da despesa.
                </p>
            @endif
        </div>
    </div>
    ...
    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="bg-white dark:bg-dark-surface border border-surface-200 dark:border-dark-border rounded-lg p-4">
            <p class="text-sm text-gray-600 dark:text-dark-muted">Total das despesas filtradas</p>
            <p class="text-2xl font-semibold dark:text-dark-text">
                R$ {{ number_format($totalFilteredExpenses, 2, ',', '.') }}
            </p>
        </div>
        <div class="bg-white dark:bg-dark-surface border border-surface-200 dark:border-dark-border rounded-lg p-4">
            <p class="text-sm text-gray-600 dark:text-dark-muted">Quantidade de despesas</p>
            <p class="text-2xl font-semibold dark:text-dark-text">{{ $expensesCount }}</p>
        </div>
    </div>
